...
from app.my_data import info_json
...
async def me():
    return {
        ...
        "skills": [
            ...
            "Docker Compose", "Asynchronous Python",
            "SQL", "PostgreSQL", "Redis", "Azure", "Google Cloud", "AWS",
            "GitHub Actions", "CI/CD"
        ],
        "bio": (
            "I am a Python developer with specializing in Python, Django,"
